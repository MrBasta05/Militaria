...
--
-- Host: 127.0.0.1
-- Czas generowania: 14 Cze 2022, 00:30
...
(1, 'Karabinek DD M4A1 14,5\" - 5,56 mm NATO / .223Rem', '11500.00', 'Karabinek DD M4A1 - żywa \"legenda\" - wyposażony jest w łoże M4A1 RIS II, które jest w użyciu w jednostkach US Special Operations Command (SOCOM) w systemie uzbrojenia SOPMOD II od 2005r. \n\nErgonomiczne lekkie łoże z zestawem szyn Picatinny pozwala na swobodne montowanie dowolnych akcesoriów i optyki oraz zapewnia pewny chwyt broni.\n\nKarabinek Daniel Defense M4A1 z lufą 14,5\" bazuje na sprawdzonej konstrukcji AR-15.', 4, 1, 10),
(2, 'DDM4 V11', '9000.00', 'DDM4 V11 PRO z lufą 16\" i 18\" to jedne z najnowszych modeli z rodzin karabinków firmy Daniel Defense. Bazują na modelu DDM4 S2W ale posiadają dodatkowe modyfikacje dedykowane dla strzelców dynamicznych.\n\nSpust Geissele Automatics Super Dynamic 3 Gun - jeden z najlepszych spustów w swojej kategorii zapewniający idealną kontrolę i szybkość oddawanych strzałów.', 4, 2, 10),
(3, 'Karabin DD5V2 18\" - 308Win - M-LOK - Daniel Defens', '13000.00', 'Ponad 10 lat doświadczenia czołowych inżynierów Daniel Defense przyczyniło się do wprowadzenia zupełnie nowego, zaskakującego rozwiązania dla platformy .308 jakim został karabin DD5V2.\n\nNajważniejsze cechy:\n\nInnowacyjny czteropunktowy montaż łoża przedniego typu KeyMod z najwyższej jakości lufą wytwarzaną metodą kucia na zimno do komory zamkowej\nZmodyfikowany zamek z powiekszoną zawleczką zamka (cam pin), ulepszonym pazurem wyciągu oraz podwójnym wyrzutnikiem\nKomora spustowa posiada zintegrowaną powiększoną osłonę spustu, oraz gniazdo magazynka kompatybilne z magazynkami od SR-25', 4, 1, 10),
(4, 'Karabin mod. NC-10, kaliber: 308 WIN ', '12900.00', 'Karabin mod. NC-10 kaliber: 308 WIN na podstawie platformy AR-10 zaprojektowany dla profesjonalnych strzelców, wymagających najwyższej precyzji zarówno na stanowisku jak i na tarczy.  Karabinki NC-10 pozwalają użytkownikowi wykorzystać potencjał kalibru .308 Win na dystansach nawet powyżej 800m.', 4, 1, 4),
(5, 'Karabin Nemo Omen Watchmen kal. .300 WINMAG , 24\"', '33000.00', 'Jeśli zastanawiasz się nad wyborem karabinu długodystansowego w kalibrze .300  - trafiłeś na właściwy produkt. Model Watchman z 24\" lufą jest bardzo lekki i celny.\n\nPierwsza na świecie konstrukcja typu semi-auto w kalibrze .300 Win Mag.\n\nZbudowana specjalnie pod bardzo długie dystanse. Model Watchman posiada 24” lufę z włókna karbonowego \"Proof Research\" , która jest produkowana w zakładach NEMO. Extremalnie niski odrzut zapewniany jest przez nowy, opatentowany przez NEMO Arms system, który jest innowacją na rynku.', 4, 3, 2),
(6, 'Karabinek sportowy Saiga AK TR3-7 - 7,62x39 - Kala', '8000.00', 'Karabinek Sportowy Saiga AK TR3-7 został wyprodukowany przez rosyjski koncern Kalashnikov Group jako cywilna wersja karabinka AK-12 i AK-15. \n\nKultywujący radziecką myśl technologiczną AK-12 jest rosyjską odpowiedzią na karabinek M-16. Broń określana jest mianem piątej generacji karabinków Kałasznikowa, wyznaczając nowy standard dla karabinków platformy AK.', 4, 1, 6),
...
(13, 'PISTOLET HS PRODUKT S7 - 3.3 - 9X19 MM', '3.00', ' HS Produkt w roku 2020 na nowo definiuje to, czego można oczekiwać od nowoczesnego pistoletu. \n\nPistolet S7 3.3 jest drugą generacją kultowego pistoletu XDS. Linia S charakteryzuje się małą i smukłą konstrukcją idealnie sprawdzającą się jako pistolety przeznaczone do codziennego noszenia i samoobrony. S7 3.3 posiada bezpiecznik chwytowy, bezpiecznik w języku spustowym oraz wskaźnik załadowania komory nabojowej ułatwiający wzrokową kontrolę naboju w komorze.', 5, 2, 2),
(14, 'PISTOLET HUDSON H-9 KAL.9X19MM', '5.00', 'HUDSON H9 to nowoczesny pistolet bezkurkowy, zbudowany na szkielecie stalowym, lecz konstrukcyjnie opracowanym tak by był  niewiele cięższym od aluminiowych konstrukcji.  W tworzeniu mechanizmu spustowego oparto się  na rozwiązaniach zastosowanych w modelu Colta M1911. Poprawiono natomiast charakterystykę pracy nadając mu takie cech jak płynność, liniowość oraz przewidywalność momentu strzału. Pracy spustu w pistolecie HUDSON H9 dorównuje wyczynowym modelom sportowej broni palnej. ', 5, 1, 3),
(15, 'STRZELBA SAIGA-12 IPSC - 12/76 - KALASHNIKOV GROUP', '11.00', 'Strzelba SAIGA-12 IPSC została zaprojektowana i wyprodukowana przez Kalashnikov Group specjalnie z myślą o strzelcach biorących udział w konkurencjach IPSC lub 3GUN w klasie OPEN.\n\nStrzelba zadebiutowała na targach Eurosatory w roku 2014 i od tego momentu stała się jedną z najbardziej rozpoznawalnych strzelb wykorzystywanych w strzelectwie dynamicznym. Model ten możemy spotkać na największych zawodach I.P.S.C w Europie, gdzie używają go czołowi zawodnicy. ', 6, 2, 6),
(16, 'STRZELBA SAIGA-12K - KALASHNIKOV GROUP', '6.00', 'Strzelba SAIGA 12K (030) produkcji rosyjskiej firmy IZMASH charakteryzuje się świetną jakością wykonania z dbałością o najmniejszy detal przy niezwykle wysokiej niezawodności.\n\nModel ten możemy spotkać wśród wielu jednostek specjalnych.\n\nStrzelba Saiga 12K zasilana jest amunicją 12/76 oraz 12/70.', 6, 3, 6),
...
(19, 'M1 Abrams', '10000000.00', 'Jego produkcja rozpoczęła się w roku 1980. Istniejące czołgi M1 są stale modernizowane, a starsze wersje pojazdu doprowadzane do nowoczesnych standardów M1A1SA, M1A1FEP i M1A2SEP. Czołg został nazwany imieniem generała Creightona Abramsa – dowódcy 37 Batalionu Pancernego Armii Stanów Zjednoczonych w czasie II wojny światowej, a później dowódcy wojsk amerykańskich biorących udział w wojnie wietnamskiej.', 8, 1, 9),
(20, 'KV-2', '5000000.00', 'Czołg konstrukcji klasycznej: z przodu kadłuba przedział kierowania, w środku przedział bojowy, z tyłu przedział silnikowy i za nim transmisyjny. Nad przedziałem bojowym obrotowa wieża. Kadłub spawany z pancernych płyt walcowanych i giętych, wieża spawana z płyt walcowanych. Załoga składała się z 6 ludzi (kierowca i strzelec-radiotelegrafista w przedziale kierowania, dowódca, celowniczy i dwóch amunicyjnych w wieży).', 8, 2, 5),
...
(22, 'Nóż Karambit CS:GO Fade Rainbow', '1000.00', 'Nóż typu karambit o konstrukcji full-tang, czyli z trzpieniem klingi przechodzącym przez całą szerokość rękojeści. Na końcu znajduje się kółko na palec, co zapewnia pewny chwyt. Okładziny wykonane są z tworzywa sztucznego. Profil chwytu ukształtowano w taki sposób, aby chronić palce przed przypadkowym ześlizgnięciem się na ostrze.', 7, 3, 4);
